...
public class Server {
    ...
    private String server = "Server2";

    private static int port = 30002;
    private static int status = 30003;
    ...
    //Doc.
    private void newLog() {
        log = Logger.getLogger("Server2");
        FileHandler fh;

        try {
            fh = new FileHandler("C:/Users/win/Documents/Projects Java/Server/Server2/Logs/Server2.log");
            log.addHandler(fh);
    ...
    private void getRole(int port) {
        File folder = new File("C:/Users/win/Documents/Projects Java/Server/Server2/Files");
