...
public class Server {
    ...
    private String server = "Server3";

    private static int port = 30004;
    private static int status = 30005;
    ...
    //Doc.
    private void newLog() {
        log = Logger.getLogger("Server3");
        FileHandler fh;

        try {
            fh = new FileHandler("C:/Users/win/Documents/Projects Java/Server/Server3/Logs/Server3.log");
            log.addHandler(fh);
    ...
    private void getRole(int port) {
        File folder = new File("C:/Users/win/Documents/Projects Java/Server/Server3/Files");
