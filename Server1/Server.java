...
public class Server {
    ...
    private static int status = 30001;
    ...
    //Doc.
    private void newLog() {
        log = Logger.getLogger("Server1");
        FileHandler fh;

        try {
            fh = new FileHandler("C:/Users/win/Documents/Projects Java/Server/Server1/Logs/Server1.log");
            log.addHandler(fh);
    ...
    private void getRole(int port) {
        File folder = new File("C:/Users/win/Documents/Projects Java/Server/Server1/Files");
